...
if analizer_select =='ERBA XL-1000':
    analiser_df =pd.read_excel(https://github.com/bedyanya/bedyanya/blob/bedyanya/ERBAXL-1000.xlsx,sheet_name='Лист1',engine='openpyxl',parse_dates=['дата списания', 'дата поставки'])
