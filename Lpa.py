...
с21 = col2.number_input('  OD 1',value= 21234,step=0.1,format="%f")
с22 = col2.number_input('  OD 2',value= 88297,step=0.1, format="%f")
с23 = col2.number_input('  OD 3',value= 426110,step=0.1,format="%f")
с24 = col2.number_input('  OD 4',value= 2105020,step=0.1,format="%f")
с25 = col2.number_input('  OD 5',value= 8591976,step=0.1,format="%f")
с26 = col2.number_input('  OD 6',value= 15766599,step=0.1,format="%f")
